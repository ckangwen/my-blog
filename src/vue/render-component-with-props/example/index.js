(function () {
  ...
  ***************************************************************************** */
  ...
  function generatePatch(modules) {
      ...
      function createComponent(vnode, parentEl, refEl) {
          var data = vnode.data;
          if (data) {
      ...
      function createElm(vnode, parentEl, refEl) {
          ...
          if (createComponent(vnode, parentEl, refEl)) {
              return;
          }
          if (tag) {
              // 创建真实DOM
  ...
  var patch = generatePatch([hookModule, hookModule$1, hookModule$2, hookModule$3]);
  ...
  function resolveConstructorOptions(Ctor) {
      ...
      /* 当前函数是Vue的扩展子类 */
      if (Ctor.super) { // Ctor.super在Vue.extend时会被定义为父类
          /* 先获取父类解析后的options */
          // TODO 将解析后的options存放到一个map中，此后通过类的cid来获取解析后的值，是否可行?
  ...
  function installComponentHooks(data) {
      ...
      for (var key in componentVNodeHooks) {
  ...
  var Vue = /** @class */ (function () {
      ...
      Vue.prototype.$destory = function () {
          ...
          (vm._watchers || []).forEach(function (item) {
              item.teardown();
          });
  ...
  var Comp = Vue.component('hello-text', {
      ...
      render: function (h) {
          var _a = this, text = _a.text, onClick = _a.onClick, msg = _a.msg;
          return (h('div', {}, [
