...
import { isPrimitive, isDef } from '../utils';
import { Module, ModuleHooks, ModuleHookSet } from '../types/patch-hook';
...
export function generatePatch(modules: ModuleHooks[]) {
  ...
  function createComponent(vnode: VNode, parentEl: Node, refEl?: Node) {
 ...
 * @param args hook的参数
 */
const callPatchHook = (obj: ModuleHookSet | ModuleHookSet[], hook: HookEnums, ...args) => {
